...
const translations: Record<Language, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.copy": "这里只能修改 Telegram 设置。密钥会发送到后端，绝不会返回浏览器。",
...
translations["en-US"] = {
  ...
  "settings.eyebrow": "Service configuration", "settings.title": "Settings", "settings.subtitle": "Review runtime connectivity and update safe notification preferences.", "settings.loading": "Loading settings…", "settings.loadError": "Could not load settings.", "settings.runtime": "Runtime status", "settings.connections": "Service connections", "settings.apiAuth": "API authentication", "settings.browser": "Browser service", "settings.encryption": "Database encryption", "settings.telegram": "Telegram", "settings.payment": "Payment handling", "settings.notUsed": "not used by panel", "settings.notifications": "Notifications", "settings.delivery": "Telegram delivery", "settings.copy": "Only Telegram settings can be changed here. Secrets are sent to the backend and are never returned to the browser.", "settings.enableTelegram": "Enable Telegram notifications", "settings.notificationDetail": "Receive stock, checkout, and worker failure events.", "settings.botToken": "Bot token", "settings.replaceToken": "Configured, enter to replace", "settings.pasteToken": "Paste Bot token", "settings.chatId": "Chat ID", "settings.replaceChat": "Configured, enter to replace", "settings.enterChat": "Enter Telegram Chat ID", "settings.save": "Save settings", "settings.saving": "Saving…", "settings.test": "Send test message", "settings.testing": "Testing…", "settings.saved": "Telegram settings saved.", "settings.saveError": "Could not save Telegram settings.", "settings.testFailed": "Telegram test failed.", "settings.configured": "Configured", "settings.notConfigured": "Not configured", "settings.enabled": "Enabled", "settings.disabled": "Disabled",
