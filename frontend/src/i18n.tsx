...
const translations: Record<Language, Record<string, string>> = {
  "zh-CN": {
    ...
    "updates.eyebrow": "版本记录",
    "updates.title": "更新日志",
    "updates.subtitle": "查看 NOCIX 控制面板的功能、修复和运行体验更新。",
    "updates.recent": "最近更新",
    "updates.viewAll": "查看全部更新 →",
    "updates.backToOverview": "返回概览",
    "updates.entryLabel": "更新",
    "updates.date": "日期",
    "updates.type.feat": "新增",
    "updates.type.fix": "修复",
    "updates.type.docs": "文档",
    "updates.type.security": "安全",
